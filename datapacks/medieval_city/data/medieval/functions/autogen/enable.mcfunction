...
tellraw @a {"rawtext":[{"text":"Medieval City: autogen flag set to 1. Note: advanced autogen cell-tracking is currently disabled; this flag is reserved for future use."}]}
